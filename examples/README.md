...
* [Simple Example](./simple_example) - Includes examples of GoRouter integration, distributed tracing, interaction tracking, error/crash reporting, and Datadog Flags dogfooding.
